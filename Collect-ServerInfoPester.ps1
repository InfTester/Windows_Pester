<#
.SYNOPSIS
Collect-ServerInfo.ps1 - PowerShell script to collect information about Windows servers and desktops

.DESCRIPTION 
This PowerShell script runs a series of WMI and other queries to collect information
about Windows servers. To be re-written using the Common Interface Model. 

.OUTPUTS
Each System's results are output to HTML.
