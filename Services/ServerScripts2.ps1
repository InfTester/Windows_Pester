...
.EXAMPLE
   Write-HTML -Computername localhost, SRV-2019, DC-01, DC-02
...
param([Parameter(Mandatory=$false,
      ...
      [string]$FilePath = "C:\users\$env:USERNAME\onedrive\desktop\Write-HTML.html",
...
$guestacc = net user Guest | Select-Object "Account Active" | ConvertTo-HTML -Fragment -As Table -PreContent "<h2>Local Admins</h2>" | Out-String
...
$Report = ConvertTo-Html -Title "$Computername" `
                         ...
                         -Body "$Hardware $PercentFree $Restarted $Services $Stopped $guestacc $Css" }
